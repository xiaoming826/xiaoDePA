...
//    private static boolean LOGE = false;
    ...
    public static void v(String tag, String format, Object... args) {
        if (LOGV) {
            Log.v(formartLength("&" + tag, 28), buildMessage(format, args));
        }
    }

    public static void v(Throwable throwable, String tag, String format, Object... args) {
        if (LOGV) {
            Log.v(formartLength("&" + tag, 28), buildMessage(format, args), throwable);
        }
    }
    ...
    public static void d(String tag, String format, Object... args) {
        if (LOGD) {
            Log.d(formartLength("&" + tag, 28), buildMessage(format, args));
        }
    }

    public static void d(Throwable throwable, String tag, String format, Object... args) {
        if (LOGD) {
            Log.d(formartLength("&" + tag, 28), buildMessage(format, args), throwable);
        }
    }

    public static void i(String tag, String format, Object... args) {
        if (LOGI) {
            Log.i(formartLength("&" + tag, 28), buildMessage(format, args));
        }
    }

    public static void i(Throwable throwable, String tag, String format, Object... args) {
        if (LOGI) {
            Log.i(formartLength("&" + tag, 28), buildMessage(format, args), throwable);
        }
    }

    public static void w(String tag, String format, Object... args) {
        if (LOGW) {
            Log.w(formartLength("&" + tag, 28), buildMessage(format, args));
        }
    }

    public static void w(Throwable throwable, String tag, String format, Object... args) {
        if (LOGW) {
            Log.w(formartLength("&" + tag, 28), buildMessage(format, args), throwable);
        }
    }
    ...
    public static void e(String tag, String format, Object... args) {
        if (LOGE) {
            Log.e(formartLength("&" + tag, 28), buildMessage(format, args));
        }
    }

    public static void e(Throwable throwable, String tag, String format, Object... args) {
        if (LOGE) {
            Log.e(formartLength("&" + tag, 28), buildMessage(format, args), throwable);
        }
    }
